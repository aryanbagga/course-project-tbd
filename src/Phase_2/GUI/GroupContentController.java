...
public class GroupContentController implements Initializable{
    ...
    public void setAll(UserManager um, GroupManager gm, TaskManager tm, String userId, String groupId,
        ...
        Invite.setVisible(gm.checkIfLeader(groupId, um.getUserById(userId)));
    ...
    public void InvitePushed() throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("fxmlFiles/InviteMemberPresenter.fxml"));
        Parent root = loader.load();
        InviteMemberController imc = loader.getController();
        imc.setAll(um, gm, tm, userId, groupId, nm);
        Scene scene = new Scene(root);
        GUImain guiMain = new GUImain();
        guiMain.addScene(scene);
    }
